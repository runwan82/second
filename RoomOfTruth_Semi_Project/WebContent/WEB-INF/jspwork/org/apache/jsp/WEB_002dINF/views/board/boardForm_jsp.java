 ...
 * Generated at: 2020-07-16 00:50:41 UTC
...
public final class boardForm_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 if(memberLoggedIn.getMemberRole().equals("A")){ 
	...
	List<RoomImage> imgList = (List<RoomImage>)request.getAttribute("imgList");
      ...
      out.write("\tif($(\"#cerEmail\").val()==null) alert(\"메일주소를 입력해주세요\");\r\n");
      out.write("\t\t$.ajax({\r\n");
      out.write("\t\t\turl: \"");
      out.print( request.getContextPath() );
      out.write("/board/sendMail\",\r\n");
      out.write("\t\t\tmethod: \"POST\", \r\n");
      out.write("\t\t\tdataType: \"text\", //html, text, json, xml 리턴된 데이터에 따라 자동설정됨\r\n");
      out.write("\t\t\tdata:  {\"email\": $(\"#cerEmail\").val()}, //사용자 입력값전달\r\n");
      out.write("\t\t\tsuccess: function(data){\r\n");
      out.write("\t\t\t\talert(\"인증번호가 전송되었습니다! 30초 안에 인증을 완료해 주세요!!!\")\r\n");
      out.write("\t\t\t},\r\n");
      out.write("\t\t\terror: function(xhr, textStatus, errorThrown){\r\n");
      out.write("\t\t\t\talert(\"메일주소가 일치하지 않습니다.\")\r\n");
      ...
      out.write("//신고\r\n");
      out.write("$(document).ready(function(){\r\n");
      out.write("    $(\"#cerSubmit\").click(function(){\r\n");
      out.write("\tif($(\"#cerNumber\").val()==null) alert(\"메일주소를 입력해주세요\");\r\n");
      out.write("\t\t$.ajax({\r\n");
      out.write("\t\t\turl: \"");
      out.print( request.getContextPath() );
      out.write("/board/report\",\r\n");
      out.write("\t\t\tmethod: \"POST\", \r\n");
      out.write("\t\t\tdataType: \"text\", //html, text, json, xml 리턴된 데이터에 따라 자동설정됨\r\n");
      out.write("\t\t\tdata:  {\"cerNumber\": $(\"#cerNumber\").val(),\r\n");
      out.write("\t\t\t\t\t\"br_cp_id\" : $(\"#cerHidden\").val(),\r\n");
      out.write("\t\t\t\t\t\"board_num\" : $(\"#cerHidden2\").val()\r\n");
      out.write("\t\t\t\t}, //사용자 입력값전달\r\n");
      out.write("\t\t\tsuccess: function(data){\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t},\r\n");
