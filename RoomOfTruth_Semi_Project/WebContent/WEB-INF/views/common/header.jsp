						...
						<li class="nav-item"><a href="<%=request.getContextPath() %>/board/boardList" class="nav-link">방 찾기</a></li>
							...
							<ul class="profile__list">
			                  ...
			                  <li class="login-mypage" id="login-mypage-info" >
			                    <div onclick="location.href='<%= request.getContextPath() %>/admin/memberList';">회원정보 조회</div>
			                  </li>
			                  <% } else{ %>
			                  <li class="login-mypage" id="login-mypage-info" >
			                    <div onclick="location.href='<%= request.getContextPath() %>/member/memberProfileView'">내 정보 보기</div>
			                  </li>
			                  <% } %> 
	        ...
	        <div id="wrap">
	            <div class="form-wrap">
	                ...
	                <form action="<%= request.getContextPath() %>/member/login" id="login" method="post" class="input-group">
	                    ...
	                    <input type="password" id="loginPwd" name="password" class="input-field" placeholder="비밀번호를 입력해주세요" required>
	                    <div id="chkWrap">
		                    <input type="checkbox" class="checkbox" name="saveId" <%= saveIdChecked ? "checked" : "" %> />아이디 저장
		                    <span class="checkbox brokerChk" id="br_frm" onclick="location.href='<%= request.getContextPath() %>/broker/login'"  >중개인이세요?</span>
	                    </div>
	                    <input type="submit" class="submit" value="로그인" />
	                    <a id="findLink" onclick="findLink()">비밀번호 찾기</a>
	                </form>
