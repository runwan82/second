...
/**
 * @실습문제 로그인한 사용자의 상세보기가 아닌
 * 다른 사용자의 상세보기를 요청한 경우,
 * 진행될 수 없도록 처리할 것.
 * "잘못된 경로로 접근하셨습니다." 사용자 피드백후, 
 * 로그인한 사용자의 상세보기 페이지로 이동할것
 * 
 */
//@WebFilter("/member/memberProfile")
...
//		System.out.println("memberId@MemberAuthFilter="+memberId);
		...
		||!(
			...
			request.setAttribute("loc", "/member/memberProfile?memberId="+memberLoggedIn.getMemberId());
